...
def front_analysise(args):
    ...
    o.custom_write()
    o.write_effective_info(b_analysise.get_effective_keyword(),\
        b_analysise.get_effective_function())
    o.write_hidden_keywords(f_analysise.hidden_keywords)
    o.write_annotation_keywords(f_analysise.annotation_keywords)
    o.write_form_requests(f_analysise.form_request_list)
