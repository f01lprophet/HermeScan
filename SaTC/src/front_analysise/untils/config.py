...
# 不对以下固件中的文件进行处理
SPECIAL_MID_NAME = [".so", ".ko", ".svn", "qemu-arm-static", "qemu-mipsel-static", "qemu-arm-static",
                    "qemu-mipsel-static", "qemu-mipseb-static"]
# TODO: configure private libraries for analysis
PRIVATE_LIBS = ["libncc_comm.so", "libleopard.so"]
# SPECIAL_MID_NAME = [".ko"]
...
# similarity threthod
SIM_RATIO_UPPER = 0.78
SIM_RATIO_ACCUR = 0.83
SIM_RATIO = (SIM_RATIO_UPPER, SIM_RATIO_ACCUR)
SEM_RATIO = 0.50