...
from front_analysise.untils.config import SPECIAL_COMMAND, SPECIAL_MID_NAME, PRIVATE_LIBS, REMOVE_FILE, SPECIAL_PATH
        ...
        for mid_name in SPECIAL_MID_NAME:
            for file in elfs:
                ...
                if file.find(mid_name) > 0 \
                    and file_name not in PRIVATE_LIBS \
                        and file in self._elffile:
